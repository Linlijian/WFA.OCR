namespace WFA.OCR.UserControls
{
	partial class UCOCRS01
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UCOCRS01));
			...
			this.lblDetailDownloadLanguage.Size = new System.Drawing.Size(232, 19);
			this.lblDetailDownloadLanguage.TabIndex = 38;
			this.lblDetailDownloadLanguage.Text = "Data Files for Version 3.04/3.05";
			// 
			// ucScrollbar1
			// 
			...
			this.Load += new System.EventHandler(this.UCOCRS01_Load);
