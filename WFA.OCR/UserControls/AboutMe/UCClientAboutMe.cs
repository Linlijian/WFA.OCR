...
{
	public partial class UCClientAboutMe : UserControl
	{
		public UCClientAboutMe()
		{
			InitializeComponent();
			HideActive();
		}
		...
		private void UCClientAboutMe_Load(object sender, EventArgs e)
		{
			Global.PActiveHide(panelClient);
			Global.PActiveShow(PActive1);
			UserControlHelper.SetUserControl(panelClientTask, userControl: new UCABM001(), dockStyle: UserControlDockStyle.DockStyleFill);
		}
