namespace WFA.OCR.UserControls
{
	partial class UCClientBody
	{
		...
		private void InitializeComponent()
		{
			...
			this.btnGroupImage.Image = global::WFA.PlugIn.Image.ImageResource.folder_64px;
			...
			this.btnSetting.Image = global::WFA.PlugIn.Image.ImageResource.settings_64px;
			...
			this.btnImagetoPDF.Image = global::WFA.PlugIn.Image.ImageResource.pdf_64px;
			...
			this.btnPDFtoImage.Image = global::WFA.PlugIn.Image.ImageResource.image_file_64px;
			...
			this.btnPDFtoImage.Name = "btnexam";
			...
			this.btnPDFtoImage.Text = "Exam";
			this.btnPDFtoImage.UseVisualStyleBackColor = true;
			this.btnPDFtoImage.Click += new System.EventHandler(this.btnexam_Click);
			// 
			// UCClientBody
			// 
