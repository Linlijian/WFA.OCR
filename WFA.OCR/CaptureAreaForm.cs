...
namespace WFA.OCR
{
	public partial class CaptureAreaForm : Form
	{
		...
		Pen EraserPen = new Pen(Color.FromArgb(255, 255, 192), 2);
		...
		private void DragSelection()
		{
			...
			else if (Cursor.Position.X - DragClickRelative.X > 0) //Selection area has reached the right side of the screen
			{
			...
			else if (Cursor.Position.Y - DragClickRelative.Y > 0) //Selection area has reached the bottom of the screen
			{
		...
		public void Translate(bool showCursor)
		{
