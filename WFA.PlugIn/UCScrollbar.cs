...
namespace CustomControls {
    ...
    public class UCScrollbar : UserControl {
        ...
        public UCScrollbar() {
            ...
            UpArrowImage = WFA.PlugIn.Image.Scollbar.uparrow;
            DownArrowImage =  WFA.PlugIn.Image.Scollbar.downarrow;
            

            ThumbBottomImage =  WFA.PlugIn.Image.Scollbar.ThumbBottom;
            ThumbBottomSpanImage =  WFA.PlugIn.Image.Scollbar.ThumbSpanBottom;
            ThumbTopImage =  WFA.PlugIn.Image.Scollbar.ThumbTop;
            ThumbTopSpanImage =  WFA.PlugIn.Image.Scollbar.ThumbSpanTop;
            ThumbMiddleImage =  WFA.PlugIn.Image.Scollbar.ThumbMiddle;
        ...
        protected override void OnPaint(PaintEventArgs e) {
            ...
            Brush oWhiteBrush = new SolidBrush(Color.Black);
        ...
        private void InitializeComponent() {
            ...
            // UCScrollbar
            // 
            this.Name = "UCScrollbar";
            this.MouseDown += new System.Windows.Forms.MouseEventHandler(this.UCScrollbar_MouseDown);
            this.MouseMove += new System.Windows.Forms.MouseEventHandler(this.UCScrollbar_MouseMove);
            this.MouseUp += new System.Windows.Forms.MouseEventHandler(this.UCScrollbar_MouseUp);
            this.ResumeLayout(false);

        }

        private void UCScrollbar_MouseDown(object sender, MouseEventArgs e) {
        ...
        private void UCScrollbar_MouseUp(object sender, MouseEventArgs e) {
        ...
        private void UCScrollbar_MouseMove(object sender, MouseEventArgs e) {
            if(moThumbDown == true)
            {
